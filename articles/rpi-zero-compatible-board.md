...
| 無線   | BT/Wifi(技適無さそう)     |
| 消費電力 |                     |
| 値段   | 3200(1GB)-5800(4GB) |

- <https://youtu.be/mD4jN6DyF7M>

# おまけ

クセがあり個人的には選定対象外だがPi Zeroフォームファクタのものはこちら。
...
- 無線があれば使ってみたかったけどね…
  - RPi Radio Module 2を使えば一応無線自体は可能だと思われる
...
- こちらもRISC-V。
  - 中華チップでドキュメント類も中国語ばかり
- Linuxも動かせなくはないと思うがこのメモリだと厳しそう
  - と思ったがbuildrootならいけるよう: <https://zenn.dev/usagi1975/articles/2024-08-18-000_k230_canmv>
