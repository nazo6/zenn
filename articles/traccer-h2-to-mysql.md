...
@[card](https://github.com/traccar/traccar/issues/5164)
...
@[card](https://www.traccar.org/mysql/)
...
@[card](https://www.traccar.org/forums/topic/suggestions-for-a-good-migration-tool-to-convert-h2-to-mysql/)
...
:::
![](/images/5f6eee8146c7.png)
Export targetでは「データベース」を選択し次へ
![](/images/b9b729fbb546.png)
...
> この記事は[個人ブログ](https://nazo6.dev/blog/article/traccer-h2-to-mysql)とクロスポストしています。