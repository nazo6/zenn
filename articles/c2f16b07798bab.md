...
- Windows でも MacOS でも Linux でも動くはずですが、NixOS ではその仕様上 mason.nvim が動きません。
- Neovim stable 最新版もしくは nightly
- git コマンド
- その他`checkhealth mason`で指定されたコマンドが必要です
...
[lazy.nvim](https://github.com/folke/lazy.nvim)を使った設定例が以下になります。
