...
@[card](https://github.com/ms-jpq/coq_nvim)
...
@[card](https://zenn.dev/yutakatay/articles/neovim-pluginlist)

## LSP 拡張系

- lsp\_signature.nvim

  @[card](https://github.com/ray-x/lsp_signature.nvim)

  関数の引数を入力しているときにシグネチャヘルプを表示してくれます。

- lspkind-nvim

  @[card](https://github.com/onsails/lspkind-nvim)

  補完にアイコンを追加してくれます。

- fidget.nvim

  @[card](https://github.com/j-hui/fidget.nvim)

  言語サーバの稼働状況などを表示してくれるやつです。VSCodeの右下に出ているものを再現できます。

- noice.nvim

  @[card](https://github.com/folke/noice.nvim)

  neovim の UI 全般を魔改造するプラグインです。lsp\_signature.nvim と fidget.nvim を置き換えることができます。
...
- typescript.nvim
  ...
  @[card](https://github.com/jose-elias-alvarez/typescript.nvim)

- rust-tools.nvim

  @[card](https://github.com/simrat39/rust-tools.nvim)

- go.nvim

  @[card](https://github.com/ray-x/go.nvim)

- nvim-jdtls

  @[card](https://github.com/mfussenegger/nvim-jdtls)

- flutter-tools.nvim

  @[card](https://github.com/akinsho/flutter-tools.nvim)

# 参考になるサイト

- 公式の LSP のドキュメント

  @[card](https://neovim.io/doc/user/lsp.html)

- r/neovim

  @[card](https://www.reddit.com/r/neovim/)
...
@[card](https://github.com/nazo6/zenn/blob/main/examples/c2f16b07798bab/init.lua)

ついでに自分の neovim の設定を置いておきます。よければ参考にしてください。

@[card](https://github.com/nazo6/nvim)

それではよい neovim ライフを。


> この記事は[個人ブログ](https://nazo6.dev/blog/article/c2f16b07798bab)とクロスポストしています。