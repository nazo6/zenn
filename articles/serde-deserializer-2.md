...
@[card](https://github.com/serde-rs/example-format/blob/master/src/de.rs)

からのコピペですが若干違うところもあるので

@[card](https://github.com/nazo6/serde-deserializer-example)
...
> この記事は[個人ブログ](https://nazo6.dev/blog/article/serde-deserializer-2)とクロスポストしています。